...
## Исторические заглушки

Старые файлы 2017 (`meta`, placeholder `robots.txt` / `sitemap`) —
в `archive/2017-stub/`. Имя `Без названия-3` **никогда не возвращать**
в новых коммитах: любой add/touch сбрасывает дату на GitHub.
